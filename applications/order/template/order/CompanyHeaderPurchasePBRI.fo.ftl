											...
											<fo:table-body>
															...
															<fo:table>
																<fo:table-body>
																	<fo:table-row>
																		...
																		<fo:table-cell width="5cm" text-align="left"><fo:block>${partyId!}</fo:block></fo:table-cell>
																	</fo:table-row>
																	<fo:table-row>
												...
												<fo:table-row>
													<fo:table-cell text-align="left" padding="2mm">
														<fo:block>We are pleased to place the order for the following items :</fo:block>
													</fo:table-cell>
												</fo:table-row>
											</fo:table-body>
										</fo:table>
